...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("sfx_hammerswing_l"));
...
set_hitbox_value(AT_FAIR, 1, HG_MUNO_HITBOX_NAME, "Clean");
...
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 112);
...
set_hitbox_value(AT_FAIR, 2, HG_MUNO_HITBOX_NAME, "Late");
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("sfx_hammerhit_m"));