...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("sfx_dedede_dattack02"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("sfx_dedede_dattack01"));
...
set_window_value(AT_DATTACK, 4, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_DATTACK, 1, HG_KNOCKBACK_SCALING, 1.1);
...
set_hitbox_value(AT_DATTACK, 2, HG_KNOCKBACK_SCALING, 0.8);
